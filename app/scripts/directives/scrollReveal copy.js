...
angular.module('angularApp')
  .directive('reveal', ['$timeout', '$window', function ($timeout, $window) {
...
link:  function linkFunc(scope, element, attrs) {
            ...
            scrollReveal.prototype = {
              ...
              /*  console.log(self.theElem);
                ...
                console.log(self.theElem + ' will be revealed');*/

                var elem = self.theElem;
                self.initial = { 'opacity' : 0, 'padding-top' : '+=15' };
                self.transition = { 'webkit-transition' : 'all 0.5s cubic-bezier( 0.6, 0.2, 0.1, 1 )'};
                self.reveal = { 'opacity': 1 , 'padding-top' : '-=15' };
                self.vFactor = 0.4;
                self.seen = false;

                elem.css( self.initial ).css( self.transition );
                  ...
                  var visible;
                      ...
                      if ( visible && !self.seen ){
                        ...
                        $timeout(function(){
                          ...
                          elem.css( self.reveal ).css( self.transition );
                          
                          },2000);

                        console.log('reveal element '+self.index+' in view');
                ...
                isElemInViewport: function(){
                  ...
                  var elTop= (self.theElem.offset().top - ($window.innerHeight)),
                  scrolled = angular.element($window).scrollTop(),
                  elHeight = self.theElem.height(),
